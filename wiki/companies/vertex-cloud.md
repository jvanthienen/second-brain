...
>
> **Last reviewed:** 2026-08-05 · **Encountered at:** 1 account
...
Three things, observed once, so treat as provisional:
...
[[Kai Nakamura]] reported they had no answer on **reserved capacity windows**. For a customer
whose real pain is hardware availability rather than unit price, that is a material gap — and it
is currently our strongest technical differentiator at that account.

## What to watch

Whether the same pattern appears at other accounts. The entry route — finance-first, senior-early
— is a repeatable play against any single-threaded account, and it maps directly onto

...
> **The catalog.** Every page in the wiki, with a one-line summary.
>
> The agent reads this first when answering a question, then drills into the relevant pages.
> Updated on every ingest.
>
> **Pages:** 17 · **Sources ingested:** 6 · **Last updated:** 2026-08-05

---

## Accounts

*What's happening now. Read before a customer meeting.*
...
*Who they are. Read when joining an account.*
...
*Dynamics seen more than once.*

| Page | Summary | Instances |
|---|---|---|
| [[Commitment Flexibility vs Discount Depth]] | Customers decline commitments to keep optionality; we answer with discount. | 3 |
| [[Champion Dependency Risk]] | Single-threaded accounts with no executive coverage. | 2 |

## Blockers

*Specific things that are stuck.*
...
- What is the trigger for escalating to executive sponsorship? Currently appears to be

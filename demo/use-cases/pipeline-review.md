...
**HubSpot or Attio (you admin it):**

1. Find the MCP URL: search "HubSpot MCP" or "Attio MCP" in their docs.
2. Claude Desktop > **Settings > Connectors > Add custom connector**.
3. Paste the URL. Sign in when the browser opens.
4. Test: "using the HubSpot connection, list my open deals."

**Salesforce or Dynamics (IT-owned):**

1. Ask your agent: "does my company run an internal MCP for our CRM?" Big companies often
   do; Microsoft folks, ask Josefina and she will point you at the right one.
2. No internal MCP? Export open opportunities as a CSV.
3. Drop the CSV into `data-pipeline/`.
4. Kick off the IT/MCP request Friday.
